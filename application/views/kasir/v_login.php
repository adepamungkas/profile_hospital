...
<head>
  ...
  <title>Asisten Dokter | Log in</title>
...
<div class="login-box">
  ...
  <div class="login-box-body">
    <div class="login-logo">
      <a href="<?php echo site_url('login2') ?>"><b>Asisten Dokter</b><br> Mitra Husada</a>
    </div>
    <p class="login-box-msg">Ketikan Data Login</p>

    <form action="<?php echo site_url('login2/cek_login2'); ?>" method="post">
