...
<head>
  ...
  <title>Admin Antrian | <?php echo humanize($this->router->fetch_class()) ?></title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <!-- Logo -->
    <a href="<?php echo site_url('admin/main') ?>" class="logo">
      <!-- mini logo for sidebar mini 50x50 pixels -->
      <span class="logo-mini"><b>A</b>MH</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Admin</b> MitraHusada</span>
    </a>
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  <?php echo $this->session->userdata('nama') ?> - Operator Web
                </p>
              </li>
              <!-- Menu Body -->
              <!-- Menu Footer-->
              <li class="user-footer">
                <a href="<?php echo site_url('login/logout') ?>" class="btn btn-default btn-block"> Keluar</a>
              </li>
            </ul>
          </li>
